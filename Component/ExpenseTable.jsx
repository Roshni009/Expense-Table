...
export default function ExpenseTable({expenses,setExpense, setExpenses, setEditingRowId }) {
  ...
  return (
    <>
    <ContextMenu menuPosition={menuPosition} setMenuPosition={setMenuPosition} expenses={expenses} setExpense={setExpense} setExpenses={setExpenses} rowId={rowId} setEditingRowId={setEditingRowId}/>

    <table className='expense-table' onClick={() => { if(menuPosition.left) {
         setMenuPosition({})
    }
    }}>
    <thead>
